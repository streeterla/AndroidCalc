...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        buttonCancel.setOnClickListener(new CancelButtonListener(this.inputField, errorField));
        ...
        if(isAvailable)
        {
	        ...
	        adRequest.addTestDevice("BX902KQQCW");
	        AdView adView = new AdView(this, AdSize.BANNER, "a1514a4addebc42");
	        LinearLayout layout = (LinearLayout)findViewById(R.id.completelayout);
    ...
    public boolean onCreateOptionsMenu(Menu menu) 
    {
        ...
        //pro version
        MenuItem upgradeItem = menu.getItem(1);
        Intent upgradeIntent = new Intent(Intent.ACTION_VIEW);
        upgradeIntent.setData(Uri.parse("market://details?id=de.sms.android.calculator.pro"));
        upgradeItem.setIntent(upgradeIntent);
        
        //exit
        MenuItem exitItem = menu.getItem(2);
